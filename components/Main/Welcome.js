  ...
  return (
    <div className="flex-1 flex flex-col justify-center p-10 mt-5">
      ...
      <div className="sm:my-14 my-8">
        <a
          rel="noreferrer"
          href="https://drive.google.com/drive/u/3/folders/1AvrsRgV1Dgi-MzF44-aj4SgmN4dsmlC_"
          target={'_blank'}
      ...
      <div className="mt-0">
        ...
        <p className="text-lg mt-2">
          I&apos;m an undergraduate student from Indian Institute of Technology
          Madras, pursuing Master&apos;s degree in Biotechnology.
        </p>
      </div>
    </div>
  );
